...
<header id="header">
	...
	<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="/register" class="btn btn-danger">Create account</a> </span>
				...
				<div class="well no-padding">
					<form method="post" action="/login" id="login-form" class="smart-form client-form">
						...
						<fieldset>
							...
							<section>
								<?php if(f3::get('notification') > '') { ?>
								<check if="{{ @notification }}">
									<div class="alert alert-warning">
										<!-- <label class="label">{{ @notification }}</label> -->
										<?php echo f3::get('notification'); ?>
									</div>
								</check>
								<?php } ?>
