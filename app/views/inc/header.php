...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>iFox </title>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <img src="<?php echo ASSETS_URL; ?>/images/ifoxlogo.svg" alt="iFox"> </span>
				...
				<!-- 		<ul class="dropdown-menu">
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="/logout" title="Sign Out" data-action="/logout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
